...
function Admin() {
    ...
    return (
        <div>
                                ...
                                <tbody>
                                    <tr className="border-b dark:border-gray-700">
                                        ...
                                        <td className="px-4 py-3 flex items-center justify-end">
                                            ...
                                            <a id="clickable" className="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                            ...
                                            }} anchorSelect="#clickable" clickable>
                                                <Dropdown setEdit={setEdit} />
                                            </Tooltip>
                                            {/* {option && } */}
                                        </td>
                                    </tr>
            ...
            {/* Update modal */}
            {edit && <ModalEdit setEdit={setEdit} />}
