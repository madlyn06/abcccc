  ...
  {category.length > 0 && category.map((item) => <div className='w-52 py-1 cursor-pointer hover:bg-blue-gray-200 px-1 rounded-md' key={item?.id}>{item.name}</div>)}
      ...
      <section className='bg-white py-8'>
        <div className='container py-8 px-6 mx-auto'>
          ...
          <p className='mb-8'>
            Lorem ipsum dolor sit amet, consectetur <a href='#'>random link</a> adipiscing elit, sed do eiusmod tempor
            incididunt ut labore et dolore magna aliqua. Vel risus commodo viverra maecenas accumsan lacus vel facilisis
            volutpat. Vitae aliquet nec ullamcorper sit. Nullam eget felis eget nunc lobortis mattis aliquam. In est
            ante in nibh mauris. Egestas congue quisque egestas diam in. Facilisi nullam vehicula ipsum a arcu. Nec nam
            aliquam sem et tortor consequat. Eget mi proin sed libero enim sed faucibus turpis in. Hac habitasse platea
            dictumst quisque. In aliquam sem fringilla ut. Gravida rutrum quisque non tellus orci ac auctor augue
            mauris. Accumsan lacus vel facilisis volutpat est velit egestas dui id. At tempor commodo ullamcorper a.
